...
class ArtistMovies extends StatefulWidget {
  ArtitstsResults results;
  ArtistMovies({Key? key, required this.results}) : super(key: key);

  @override
  _ArtistMoviesState createState() => _ArtistMoviesState();
}

class _ArtistMoviesState extends State<ArtistMovies> {
  ...
  @override
  void initState() {
    BlocProvider.of<CastmoviesCubit>(context).getCastMovies(widget.results.id!);
    BlocProvider.of<CastdetailsCubit>(context).getCastDetails(widget.results.id!);
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: CachedNetworkImage(
                    imageUrl: "${imgUrl + widget.results.profilePath!}",
